...
# @Date : 2019-03-27 9:30

# 与lxml一样,Beautiful Soup也是xml/html解析器,主要功能是如何解析和提取xml/html数据
...
# 创建BeautifulSoup对象
bs = BeautifulSoup(html_doc, 'lxml')  # lxml指定解析器
# print(bs.prettify())  # 美化打印

### beautifulsoup4的基本使用: find_all()提取数据
# 示例如下:
# 获取所有的a标签
